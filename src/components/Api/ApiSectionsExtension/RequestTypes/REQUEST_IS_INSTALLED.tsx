...
export const REQUEST_IS_INSTALLED: FC<SectionProps> = ({
  title,
  setSelectedSection,
  id
}) => {
  return (
    ...
    >
      <SectionContainer>
        ...
        >
           <SubTitle>
          Use this request to determine if the user has the extension is already
          installed. If the response is false, then direct them to install the
          Qortal Extension.
        </SubTitle>
