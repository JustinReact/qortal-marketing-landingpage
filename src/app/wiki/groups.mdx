...
<figure>
  <img src="/images/Wiki/QortalHubCreateGroup.png" alt="Creating a new group on Qortal Hub" style={{ width:"100%", maxWidth:"1000px"}} />
...
- **Group Calls:** Start voice calls with group members directly from the chat. Calls support up to **7 participants** at a time and are powered by **Reticulum** technology, enabling decentralized peer-to-peer communication without relying on central servers.
